...
class Catalog(object):
    ...
    def Products(self, j):
        ...
        if o != 0:
            ...
            from hushh.Product import Product
            obj = Product()
    ...
    def ProductEmbeddings(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from hushh.Embedding import Embedding
            obj = Embedding()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Characterizations(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from hushh.ProductCharacterization import ProductCharacterization
    ...
    def ProductInformation(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from hushh.ProductInformation import ProductInformation
